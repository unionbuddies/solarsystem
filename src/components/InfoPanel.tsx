        ...
        <div className="panel-scroll pointer-events-auto h-full overflow-y-auto rounded-t-2xl border-t border-white/10 bg-[#0a0d16]/85 px-6 pb-6 pt-4 backdrop-blur-xl sm:rounded-none sm:border-l sm:border-t-0 sm:py-6">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              onClick={clear}
              aria-label="Close"
              className="flex-none rounded-full bg-white/5 p-2 text-white/60 ring-1 ring-white/10 transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-white/10 hover:text-white hover:shadow-md hover:shadow-sky-400/15 hover:ring-white/25 active:translate-y-0"
            >
